...
import { gethomedata, getheaderandfooterdata, getaboutusdata, getcountrydata, getuniversitydata, gettermsandconditiondata } from '../Actions/Pics';
...
const TermCondition = () => {
    ...
    const termsdata = useSelector((state) => state?.Pics?.termsdata?.data);
                                    ...
                                    <div className='container relative'>
                                        <div className='row d-flex justify-content-center'>
                                            <div className='col-md-11'>
                                                <div className='terms-text' dangerouslySetInnerHTML={{ __html: termsdata?.section1?.description }}>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
